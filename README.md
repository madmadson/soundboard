...
as always use npm install to start
...
I use firebase to deploy it to the cloud. for eays usage it's enough.
Just build it with production build in /build and say firebase deploy.
